from .views import (index, events, create_event, delete_event, update_event, event_details,
                    create_ticket_tier, update_ticket_tier, delete_ticket_tier, create_parking_tier)
from .views import (tourist_spots, create_tourist_spots,
                    update_tourist_spots, tourist_spots_details, create_amenity, delete_amenity)
...
urlpatterns = [
    ...
    path('tourist_spots/create/', create_tourist_spots,
         name='create_tourist_spots'),
    path('tourist_spots/<int:id>/', tourist_spots_details,
         name='tourist_spots_details'),
    path('tourist_spots/<int:id>/amenity/',
         create_amenity, name='create_amenity'),
    path('tourist_spots/<int:tourist_spot_id>/amenity/<int:id>/delete/',
